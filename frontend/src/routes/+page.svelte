...
{#if load}
  <div class="w-full h-screen flex justify-center items-center">
    <div class="p-8">
      <div class="mx-auto flex flex-col justify-center space-y-6 w-96">
        ...
        <Button href="/api/auth/github/login" class="w-full">
          <Github />
          <span class="ml-2">Login with GitHub</span>
        </Button>

        <Button href="/api/auth/google/login" class="w-full">
          <svg
            role="img"
            class="stroke-primary fill-foreground"
            viewBox="0 0 24 24"
...
{:else}
  <div class="h-screen w-screen flex justify-center items-center">
    <div role="status">
      <svg
        aria-hidden="true"
        class="w-10 h-10 md:w-16 md:h-16 text-gray-100 animate-spin dark:text-gray-900 fill-primary"
        viewBox="0 0 100 101"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
