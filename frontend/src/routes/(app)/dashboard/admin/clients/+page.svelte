              ...
              <DropdownMenu.Content>
                <DropdownMenu.Group>
                  <a href={"/dashboard/clients/" + client.ID}>
                    <DropdownMenu.Item>More information</DropdownMenu.Item>
                  </a>
                  ...
                  <EditClient
                    clientId={client.ID}
                    logo={client.Logo}
                    wazuhHost={client.WazuhIP + ":" + client.WazuhPort}
                    wazuhUsername={client.WazuhUsername}
                    wazuhPassword={client.WazuhPassword}
                    indexerHost={client.IndexerIP + ":" + client.IndexerPort}
                    indexerUsername={client.IndexerUsername}
                    indexerPassword={client.IndexerPassword}
                  />
                </DropdownMenu.Group>
              </DropdownMenu.Content>
            </DropdownMenu.Root>
